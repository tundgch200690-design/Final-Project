...
public class MainMenuManager : MonoBehaviour
{
    ...
    [Header("Game Mode")]
    private GameModeManager.GameMode currentGameMode = GameModeManager.GameMode.None;
    ...
    {
        currentGameMode = GameModeManager.GameMode.SinglePlayer;
        Debug.Log("[MainMenuManager] Starting Single Player mode");
        
        if (GameModeManager.Instance != null)
        {
            GameModeManager.Instance.SetGameMode(GameModeManager.GameMode.SinglePlayer);
        }
    ...
    {
        currentGameMode = GameModeManager.GameMode.Multiplayer;
        Debug.Log("[MainMenuManager] Starting Multiplayer mode");
        
        if (GameModeManager.Instance != null)
        {
            GameModeManager.Instance.SetGameMode(GameModeManager.GameMode.Multiplayer);
        }
    ...
    {
        currentGameMode = GameModeManager.GameMode.None;
    ...
    public GameModeManager.GameMode GetCurrentGameMode()
    {
        return currentGameMode;
    }

    public void SetGameMode(GameModeManager.GameMode mode)
    {
